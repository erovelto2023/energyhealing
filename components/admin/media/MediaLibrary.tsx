            ...
            <div className="flex flex-col lg:flex-row gap-4 bg-[#111622] p-6 rounded-[32px] border border-slate-800 shadow-xl">
                <div className="relative flex-1 group">
                    ...
                    <input 
                        ...
                        className="w-full bg-[#0A0D14] border border-slate-800 rounded-2xl pl-12 pr-4 py-3 text-sm focus:ring-2 focus:ring-[#6366F1]/20 focus:border-[#6366F1] outline-none transition-all text-white"
                        value={search}
                    ...
                    <div className="p-4 sm:p-8 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <input 
                                    type="text"
                                    className="w-full bg-[#111622] border border-slate-800 rounded-2xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#6366F1]/20 outline-none text-white"
                                    value={editTitle}
                            ...
                            <div className="flex gap-3 pt-4">
                                <Button 
                                    ...
                                    className="flex-1 rounded-2xl border border-slate-800 h-14 font-bold text-white"
                                >
                                    Cancel
                                </Button>
                                <Button 
