...
import { getResources, removeResource } from "@/lib/actions/media.actions";
    ...
    return (
        <div className="space-y-6">
                                        ...
                                        <td className="px-8 py-5">
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="flex items-center gap-2 text-slate-600">
                                                    ...
                                                    <p className="text-[9px] font-black uppercase tracking-widest">Secure Local Storage</p>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div className="flex items-start gap-4 p-6 bg-indigo-500/5 border border-indigo-500/10 rounded-[32px]">
                ...
                <div>
                    <h5 className="font-bold text-indigo-200 uppercase tracking-widest text-xs">Digital Asset Management Protocol</h5>
                    <p className="text-indigo-400/60 text-xs mt-1 leading-relaxed">
                        All files in the warehouse are stored locally. Download metrics are tracked in real-time to monitor distribution.
                    </p>
                </div>
            </div>
        </div>
