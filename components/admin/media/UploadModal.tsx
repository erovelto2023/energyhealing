                ...
                <div className="p-4 sm:p-8 space-y-6">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-slate-500 text-base">
                            Upload images and documents to your media library.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    {!isUploading ? (
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={category} onValueChange={setCategory}>
                                    <SelectTrigger className="w-full bg-[#111622] border-slate-800 h-14 rounded-2xl focus:ring-[#6366F1]/20 text-white">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    <p className="text-xl font-bold text-white">
                                        {isDragActive ? "Release to Upload" : "Select Files"}
                                    </p>
                        ...
                        <div className="py-20 space-y-10 flex flex-col items-center justify-center">
                            ...
                            <div className="text-center space-y-3 px-10">
                                <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic">Uploading: {currentFileName}</h3>
                                <p className="text-slate-500 font-medium text-xs uppercase tracking-widest">Streaming file to server...</p>
                            </div>
                            <div className="w-full max-w-md px-4 space-y-4">
                                ...
                                <div className="flex justify-between items-center">
                                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Protocol: Direct Stream</p>
