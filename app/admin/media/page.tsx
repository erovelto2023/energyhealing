        ...
        <div className="min-h-screen bg-[#0A0D14] text-white p-6 lg:p-10">
            ...
            <div className="flex items-center gap-4 mb-10 overflow-x-auto pb-4 no-scrollbar">
                <button 
                    ...
                    className={`
                        relative flex items-center gap-3 px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all whitespace-nowrap
                ...
                <div className="ml-auto flex items-center gap-6 pr-4">
                    <div className="flex flex-col items-end">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Local Storage</p>
                        </div>
                    </div>
                </div>
            </div>
