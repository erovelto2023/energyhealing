...
export interface IGlossaryTerm {
    ...
    definition: string;      // Full in-depth explanation (Mapped to fullDefinition)
...
const GlossaryTermSchema = new Schema<IGlossaryTerm>({
    ...
    category: { type: String, required: true, default: "Energy Healing" },
...
// Middleware to sync niche and category if needed, or handle pre-save
// Middleware to sync niche and category if needed, or handle pre-save
