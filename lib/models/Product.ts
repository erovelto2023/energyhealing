...
export interface IProduct {
    id: number; // custom numeric ID to match mock data
    name: string;
    ...
    description: string; // Full description (Markdown supported ideally)
...
const ProductSchema = new Schema<IProduct>({
    ...
    slug: { type: String, unique: true, sparse: true }, // sparse allows nulls/duplicates if missing in old data
    logoUrl: { type: String },
    ...
    commissionRate: { type: String }, // Internal
    affiliateNetwork: { type: String }, // Internal
...
// Prevent recompilation of model in dev
